...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/test/FullscreenForm/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/test/FullscreenForm/css/demo.css" />
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/test/FullscreenForm/css/component.css" />
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/test/FullscreenForm/css/cs-select.css" />
		<link rel="stylesheet" type="text/css" href="/wp-content/themes/test/FullscreenForm/css/cs-skin-boxes.css" />
		<script src="/wp-content/themes/test/FullscreenForm/js/modernizr.custom.js"></script>
	</head>
	<body>
		<div class="container">
			...
			<div class="fs-form-wrap" id="fs-form-wrap">
				<div class="fs-title">
					...
					<div class="codrops-top">
						<a class="codrops-icon codrops-icon-prev" href="/"><span>Main</span></a>
					</div>
				</div>
				<form method=”POST” action="../interactive.php" id="myform" class="fs-form fs-form-full" autocomplete="off">
					<ol class="fs-fields">
						<li>
						...
						<li>
							...
							<input class="fs-anim-lower" id="q2" name="q2" type="email" placeholder="dean@road.us" />
						</li>
		...
		<script src="/wp-content/themes/test/FullscreenForm/js/classie.js"></script>
		<script src="/wp-content/themes/test/FullscreenForm/js/selectFx.js"></script>
		<script src="/wp-content/themes/test/FullscreenForm/js/fullscreenForm.js"></script>
		<script>
			(function() {
